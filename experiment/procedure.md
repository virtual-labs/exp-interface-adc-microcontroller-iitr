...
5. (Optional) You can directly copy code into the editor by clicking on **Use Code** in the View Assembly Code popup.

6. After validation, move the **Analog Input** slider and click **Convert** to convert the analog input to digital output.

7. Observe the equivalent output on the 7-segment displays. You can move the slider and click **Convert** for other values as well.

8. If you want to save your program, click **Download Code**. It will be stored as `adc_code.asm`.
